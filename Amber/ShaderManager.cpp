...
ShaderProgram& ShaderManager::createProgram(const std::string& shaderName, const std::string& vertexShaderFilename, const std::string& fragmentShaderFilename)
{
    ...
    mShaderPrograms[shaderName] = std::move(program);
