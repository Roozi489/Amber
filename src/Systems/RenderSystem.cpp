...
{
	auto graphicsApi = g_window.getGraphicsApi();
...
void RenderSystem::applyCommandQueueSettings(const CommandQueueSettings& settings)
{
	auto graphicsApi = g_window.getGraphicsApi();
	if (graphicsApi == GraphicsApi::OpenGL)
	{
...
void RenderSystem::setDynamicVBOs(const Batch& batch)
{
	auto graphicsApi = g_window.getGraphicsApi();
	if (graphicsApi == GraphicsApi::OpenGL)
	{
...
void RenderSystem::setUniforms(ShaderProgram* program, const std::vector<UniformValue>& values)
{
	auto graphicsApi = g_window.getGraphicsApi();
	if (graphicsApi == GraphicsApi::OpenGL)
	{
